...
export default function AcademySection() {
  ...
  return (
    <section id="academy" className="py-24 md:py-32 bg-[#0c0c0f] border-b border-[#22222a] relative">
        ...
        <div className="mb-16 md:mb-20">
          ...
          >
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-[#a3a299] font-light max-w-2xl">
              Learn drawing, painting and tattooing from professional artists.
            </p>
          </motion.div>
        </div>

        {/* 4 Professional Academy Courses Grid */}
            ...
            >
              ...
              <div className="p-8 pt-0 sm:p-10 sm:pt-0 grid grid-cols-1 sm:grid-cols-2 gap-4">
                <button
                  ...
                  className="py-4 text-center text-sm tracking-[0.18em] uppercase text-[#F7F6F2] bg-[#181820] border border-[#22222a] hover:border-[#c5a880] hover:text-[#c5a880] transition-colors font-mono-tech font-semibold"
                >
                  VIEW COURSE DETAILS
                </button>
                <button
                  ...
                  className="py-4 text-center text-sm tracking-[0.18em] font-semibold uppercase text-[#09090b] bg-[#c5a880] hover:bg-[#d4af37] transition-colors font-mono-tech shadow-md"
                >
                  ENROLL IN PROGRAM
                </button>
              </div>
        ...
        <div className="p-8 sm:p-12 bg-[#111115] border border-[#22222a] flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="space-y-2">
            <h4 className="font-cinzel text-2xl sm:text-3xl text-[#F7F6F2]">
              Studio Training Hours: {STUDIO_INFO.schedule}
            </h4>
            <p className="text-base sm:text-lg text-[#a3a299] font-light">
              {STUDIO_INFO.workingDays} • Hands-on practice and 1-on-1 mentorship.
            </p>
          </div>
          <a
            href="#contact"
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/85 backdrop-blur-md">
            ...
            >
              ...
              <button
                ...
                className="w-full py-4 text-sm tracking-widest text-[#09090b] bg-[#c5a880] uppercase font-semibold font-mono-tech mt-4"
              >
      ...
      {/* Course Application / Enrollment Modal */}
      <AnimatePresence>
        {applyModalCourse && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/85 backdrop-blur-md">
            <motion.div
            ...
            >
              ...
              {!submitted ? (
                <form onSubmit={handleApply} className="space-y-4">
                  ...
                  <button
                    type="submit"
                    className="w-full py-4 text-sm tracking-[0.2em] font-semibold uppercase text-[#09090b] bg-[#c5a880] hover:bg-[#d4af37] transition-colors mt-2 font-mono-tech shadow-lg"
                  >
                    SUBMIT APPLICATION
                  </button>
                </form>
